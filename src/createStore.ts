...
import characters, { CharacterState } from "./contexts/characters";
 ...
 */
const store: Store<{ characters: CharacterState }> = finalCreateStore(combineReducers({ characters: characters.reducers }));
